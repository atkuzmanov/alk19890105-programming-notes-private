...
function ca(a){a=["object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof global&&global,a];for(var b=0;b<a.length;++b){var c=a[b];if(c&&c.Math==Math)return c}return globalThis}
...
function r(a,b){a.prototype=la(b.prototype);a.prototype.constructor=a;if(ra)ra(a,b);else for(var c in b)if("prototype"!=c)if(Object.defineProperties){var d=Object.getOwnPropertyDescriptor(b,c);d&&Object.defineProperty(a,c,d)}else a[c]=b[c];a.L=b.prototype}
function t(a,b){if(b){for(var c=da,d=a.split("."),e=0;e<d.length-1;e++){var f=d[e];f in c||(c[f]={});c=c[f]}d=d[d.length-1];e=c[d];f=b(e);f!=e&&null!=f&&ba(c,d,{configurable:!0,writable:!0,value:f})}}
t("globalThis",function(a){return a||da});
...
t("String.prototype.endsWith",function(a){return a?a:function(b,c){var d=sa(this,b,"endsWith");b+="";void 0===c&&(c=d.length);for(var e=Math.max(0,Math.min(c|0,d.length)),f=b.length;0<f&&0<e;)if(d[--e]!=b[--f])return!1;return 0>=f}});
t("String.prototype.startsWith",function(a){return a?a:function(b,c){var d=sa(this,b,"startsWith");b+="";for(var e=d.length,f=b.length,g=Math.max(0,Math.min(c|0,d.length)),h=0;h<f&&g<e;)if(d[g++]!=b[h++])return!1;return h>=f}});
...
t("Object.assign",function(a){return a||ta});
t("WeakMap",function(a){function b(k){this.f=(h+=Math.random()+1).toString();if(k){k=q(k);for(var l;!(l=k.next()).done;)l=l.value,this.set(l[0],l[1])}}
function c(){}
...
function d(h,k){var l=k&&typeof k;"object"==l||"function"==l?f.has(k)?l=f.get(k):(l=""+ ++g,f.set(k,l)):l="p_"+k;var n=h.g[l];if(n&&w(h.g,l))for(var p=0;p<n.length;p++){var v=n[p];if(k!==k&&v.key!==v.key||k===v.key)return{id:l,list:n,index:p,u:v}}return{id:l,list:n,index:-1,u:void 0}}
...
t("Set",function(a){function b(c){this.f=new Map;if(c){c=q(c);for(var d;!(d=c.next()).done;)this.add(d.value)}this.size=this.f.size}
...
return b});
t("String.prototype.includes",function(a){return a?a:function(b,c){return-1!==sa(this,b,"includes").indexOf(b,c||0)}});
...
t("Reflect.construct",function(){return ua});
...
function mb(a){var b=za(a);if("object"==b||"array"==b){if(A(a.clone))return a.clone();b="array"==b?[]:{};for(var c in a)b[c]=mb(a[c]);return b}return a}
...
var Ab={},zb={};function Eb(){this.f="";this.h=Fb;this.g=null}
Eb.prototype.ga=!0;Eb.prototype.da=function(){return this.g};
Eb.prototype.J=!0;Eb.prototype.I=function(){return this.f.toString()};
function Hb(a){if(a instanceof Eb&&a.constructor===Eb&&a.h===Fb)return a.f;za(a);return"type_error:SafeHtml"}
var Fb={};function Ib(a,b){var c=new Eb;c.f=a;c.g=b;return c}
...
;var Ob=-1!=bb.indexOf("Trident")||-1!=bb.indexOf("MSIE"),Pb;var Qb;if(x.document&&Ob){var Rb=x.document;Qb=Rb?Rb.documentMode:void 0}else Qb=void 0;Pb=Qb;var Sb={},Tb=null;ea();"undefined"!=typeof Symbol&&(ea(),ia());var I=window;function Ub(a){this.f=a||{cookie:""}}
...
function gc(a){if(a&&"number"==typeof a.length){if(Ca(a))return"function"==typeof a.item||"string"==typeof a.item;if(A(a))return"function"==typeof a.item}return!1}
...
function b(p){for(var v=g,u=0;64>u;u+=4)v[u/4]=p[u]<<24|p[u+1]<<16|p[u+2]<<8|p[u+3];for(u=16;80>u;u++)p=v[u-3]^v[u-8]^v[u-14]^v[u-16],v[u]=(p<<1|p>>>31)&4294967295;p=e[0];var E=e[1],U=e[2],ma=e[3],Ec=e[4];for(u=0;80>u;u++){if(40>u)if(20>u){var Ia=ma^E&(U^ma);var Gb=1518500249}else Ia=E^U^ma,Gb=1859775393;else 60>u?(Ia=E&U|ma&(E|U),Gb=2400959708):(Ia=E^U^ma,Gb=3395469782);Ia=((p<<5|p>>>27)&4294967295)+Ia+Ec+Gb+v[u]&4294967295;Ec=ma;ma=U;U=(E<<30|E>>>2)&4294967295;E=p;p=Ia}e[0]=e[0]+p&4294967295;e[1]=
e[1]+E&4294967295;e[2]=e[2]+U&4294967295;e[3]=e[3]+ma&4294967295;e[4]=e[4]+Ec&4294967295}
...
function Dc(a,b){"string"==typeof a.className?a.className=b:a.setAttribute&&a.setAttribute("class",b)}
...
function Gc(){var a=document.body;a.classList?a.classList.remove("inverted-hdpi"):Fc(a,"inverted-hdpi")&&Dc(a,Ma(a.classList?a.classList:Cc(a).match(/\S+/g)||[],function(b){return"inverted-hdpi"!=b}).join(" "))}
...
function Jc(a){if(a instanceof Ic)return a;if("function"==typeof a.D)return a.D(!1);if(Ba(a)){var b=0,c=new Ic;c.next=function(){for(;;){if(b>=a.length)throw Hc;if(b in a)return a[b++];b++}};
...
return e};function L(){this.g=this.g;this.C=this.C}
L.prototype.g=!1;L.prototype.dispose=function(){this.g||(this.g=!0,this.o())};
function Qc(a,b){a.g?b():(a.C||(a.C=[]),a.C.push(b))}
L.prototype.o=function(){if(this.C)for(;this.C.length;)this.C.shift()()};
function Rc(a){a&&"function"==typeof a.dispose&&a.dispose()}
function Sc(a){for(var b=0,c=arguments.length;b<c;++b){var d=arguments[b];Ba(d)?Sc.apply(null,d):Rc(d)}}
;function Tc(a){if(!a)return!1;try{return!!a.$goog_Thenable}catch(b){return!1}}
...
!A(x.setImmediate)||x.Window&&x.Window.prototype&&-1==bb.indexOf("Edge")&&x.Window.prototype.setImmediate==x.setImmediate?(Xc||(Xc=Yc()),Xc(b)):x.setImmediate(b)}}
var ed=!1,fd=new Zc;function gd(){for(var a;a=fd.remove();){try{a.f.call(a.scope)}catch(b){Wc(b)}Vc(ad,a)}ed=!1}
;function M(a){this.f=0;this.m=void 0;this.i=this.g=this.h=null;this.j=this.l=!1;if(a!=xa)try{var b=this;a.call(void 0,function(c){hd(b,2,c)},function(c){hd(b,3,c)})}catch(c){hd(this,3,c)}}
...
var jd=new Uc(function(){return new id},function(a){a.reset()});
...
M.prototype.cancel=function(a){if(0==this.f){var b=new od(a);bd(function(){pd(this,b)},this)}};
...
M.prototype.A=function(a){this.f=0;hd(this,3,a)};
function hd(a,b,c){if(0==a.f){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.f=1;a:{var d=c,e=a.w,f=a.A;if(d instanceof M){sd(d,kd(e||xa,f||null,a));var g=!0}else if(Tc(d))d.then(e,f,a),g=!0;else{if(Ca(d))try{var h=d.then;if(A(h)){ud(d,h,e,f,a);g=!0;break a}}catch(k){f.call(a,k);g=!0;break a}g=!1}}g||(a.m=c,a.f=b,a.h=null,td(a),3!=b||c instanceof od||vd(a,c))}}
function ud(a,b,c,d,e){function f(k){h||(h=!0,d.call(e,k))}
function g(k){h||(h=!0,c.call(e,k))}
var h=!1;try{b.call(a,g,f)}catch(k){f(k)}}
function td(a){a.l||(a.l=!0,bd(a.C,a))}
function qd(a){var b=null;a.g&&(b=a.g,a.g=b.next,b.next=null);a.g||(a.i=null);return b}
M.prototype.C=function(){for(var a;a=qd(this);)rd(this,a,this.f,this.m);this.l=!1};
function rd(a,b,c,d){if(3==c&&b.onRejected&&!b.h)for(;a&&a.j;a=a.h)a.j=!1;if(b.f)b.f.h=null,wd(b,c,d);else try{b.h?b.g.call(b.context):wd(b,c,d)}catch(e){xd.call(null,e)}Vc(jd,b)}
function wd(a,b,c){2==b?a.g.call(a.context,c):a.onRejected&&a.onRejected.call(a.context,c)}
function vd(a,b){a.j=!0;bd(function(){a.j&&xd.call(null,b)})}
var xd=Wc;function od(a){F.call(this,a)}
D(od,F);od.prototype.name="cancel";function yd(){this.g=[];this.f=-1}
...
D(Bd,Ad);Bd.prototype.reset=function(){this.f[0]=1732584193;this.f[1]=4023233417;this.f[2]=2562383102;this.f[3]=271733878;this.f[4]=3285377520;this.j=this.h=0};
...
;function N(a){L.call(this);this.l=1;this.i=[];this.j=0;this.f=[];this.h={};this.m=!!a}
...
function Kd(a,b,c){bd(function(){a.apply(b,c)})}
...
;var ae=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};y("yt.config_",ae,void 0);function O(a){$d(ae,arguments)}
...
function me(a){var b=[];eb(a,function(c,d){var e=encodeURIComponent(String(d)),f;Aa(c)?f=c:f=[c];G(f,function(g){""==g?b.push(e):b.push(e+"="+encodeURIComponent(String(g)))})});
return b.join("&")}
...
function te(a){var b=a.f;try{var c=b.screenX;var d=b.screenY}catch(p){}try{var e=b.outerWidth;var f=b.outerHeight}catch(p){}try{var g=b.innerWidth;var h=b.innerHeight}catch(p){}b=[b.screenLeft,b.screenTop,c,d,b.screen?b.screen.availWidth:void 0,b.screen?b.screen.availTop:void 0,e,f,g,h];c=a.f.top;try{var k=(c||window).document,l="CSS1Compat"==k.compatMode?k.documentElement:k.body;var n=(new $b(l.clientWidth,l.clientHeight)).round()}catch(p){n=new $b(-12245933,-12245933)}k=n;n={};l=new yd;x.SVGElement&&
x.document.createElementNS&&l.set(0);c=uc();c["allow-top-navigation-by-user-activation"]&&l.set(1);c["allow-popups-to-escape-sandbox"]&&l.set(2);x.crypto&&x.crypto.subtle&&l.set(3);x.TextDecoder&&x.TextEncoder&&l.set(4);l=zd(l);n.bc=l;n.bih=k.height;n.biw=k.width;n.brdim=b.join();a=a.g;return n.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[a.visibilityState||a.webkitVisibilityState||a.mozVisibilityState||""]||0,n.wgl=!!I.WebGLRenderingContext,n}
var re=new function(){var a=window.document;this.f=window;this.g=a};
y("yt.ads_.signals_.getAdSignalsString",function(a){return me(qe(a))},void 0);C();function Q(a){a=ue(a);return"string"===typeof a&&"false"===a?!1:!!a}
...
b.oa&&0<b.timeout&&(f=R(function(){e||(e=!0,S(f),b.oa.call(b.context||x))},b.timeout))}else Ie(a,b)}
...
return d}
function Ne(a){if(Ca(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=Ib(a[b],null);a[c]=d}else Ne(a[b])}}
...
c.src=a}
;function Ue(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];d=Error.call(this,a);this.message=d.message;"stack"in d&&(this.stack=d.stack);this.args=[].concat(c instanceof Array?c:ka(q(c)))}
r(Ue,Error);var Ve=new Set,We=0;function Xe(a){var b=z("yt.logging.errors.log");b?b(a,"ERROR",void 0,void 0,!1,void 0):(b=be(),b.push([a,"ERROR",void 0,void 0,!1,void 0]),O("ERRORS",b))}
function Ye(a){var b=z("yt.logging.errors.log");b?b(a,"WARNING",void 0,void 0,!1,void 0):(b=be(),b.push([a,"WARNING",void 0,void 0,!1,void 0]),O("ERRORS",b))}
...
;var af=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};y("yt.msgs_",af,void 0);function bf(a){$d(af,arguments)}
...
;var gf=z("ytPubsubPubsubInstance")||new N;N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.N;N.prototype.publish=N.prototype.M;N.prototype.clear=N.prototype.clear;y("ytPubsubPubsubInstance",gf,void 0);var hf=z("ytPubsubPubsubSubscribedKeys")||{};y("ytPubsubPubsubSubscribedKeys",hf,void 0);var jf=z("ytPubsubPubsubTopicToKeys")||{};y("ytPubsubPubsubTopicToKeys",jf,void 0);var kf=z("ytPubsubPubsubIsSynchronous")||{};y("ytPubsubPubsubIsSynchronous",kf,void 0);
...
;function Df(){}
r(Df,Af);function Cf(a,b,c){isNaN(c)&&(c=void 0);var d=z("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):R(a,c||0)}
Df.prototype.start=function(){var a=z("yt.scheduler.instance.start");a&&a()};
Df.prototype.pause=function(){var a=z("yt.scheduler.instance.pause");a&&a()};
ya(Df);Df.getInstance();var Ef=[],Ff=!1;function Gf(){if("1"!=fb(ce(),"args","privembed")){var a=function(){Ff=!0;"google_ad_status"in window?O("DCLKSTAT",1):O("DCLKSTAT",2)};
...
;var Tf=0;y("ytDomDomGetNextId",z("ytDomDomGetNextId")||function(){return++Tf},void 0);var Uf={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
...
Vf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var hb=z("ytEventsEventsListeners")||{};y("ytEventsEventsListeners",hb,void 0);var Xf=z("ytEventsEventsCounter")||{count:0};y("ytEventsEventsCounter",Xf,void 0);
...
function dg(a){var b=void 0===a?{}:a;a=void 0===b.Ba?!0:b.Ba;b=void 0===b.Na?!1:b.Na;if(null==z("_lact",window)){var c=parseInt(P("LACT"),10);c=isFinite(c)?C()-Math.max(c,0):-1;y("_lact",c,window);y("_fact",c,window);-1==c&&eg();V(document,"keydown",eg);V(document,"keyup",eg);V(document,"mousedown",eg);V(document,"mouseup",eg);a&&(b?V(window,"touchmove",function(){fg("touchmove",200)},{passive:!0}):(V(window,"resize",function(){fg("resize",200)}),V(window,"scroll",function(){fg("scroll",200)})));
...
;var hg=ve("initial_gel_batch_timeout",1E3),ig=Math.pow(2,16)-1,jg=null,kg=0,lg={log_event:"events",log_interaction:"interactions"},mg=Object.create(null);mg.log_event="GENERIC_EVENT_LOGGING";mg.log_interaction="INTERACTION_LOGGING";var ng=new Set(["log_event"]),og={},pg=0,qg=0,rg=0,sg=!0,W=z("ytLoggingTransportLogPayloadsQueue_")||{};y("ytLoggingTransportLogPayloadsQueue_",W,void 0);var tg=z("ytLoggingTransportTokensToCttTargetIds_")||{};y("ytLoggingTransportTokensToCttTargetIds_",tg,void 0);
var ug=z("ytLoggingTransportDispatchedStats_")||{};y("ytLoggingTransportDispatchedStats_",ug,void 0);y("ytytLoggingTransportCapturedTime_",z("ytLoggingTransportCapturedTime_")||{},void 0);function vg(){S(pg);S(qg);qg=0;if(!ib(W)){for(var a in W){var b=og[a];b&&b.isReady()&&(wg(a,b),delete W[a],sg=!1)}ib(W)||xg()}}
...
;var Cg=z("ytLoggingGelSequenceIdObj_")||{};y("ytLoggingGelSequenceIdObj_",Cg,void 0);
...
function Fg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||P("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.mb||P("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().lb:b=Bc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=P("SESSION_INDEX",0),Q("pageid_as_header_web")&&(d["X-Goog-PageId"]=P("DELEGATED_SESSION_ID")));return d}
function Gg(a){a=Object.assign({},a);delete a.Authorization;var b=Bc();if(b){var c=new Bd;c.update(P("INNERTUBE_API_KEY",void 0));c.update(b);b=c.digest();c=3;Ba(b);void 0===c&&(c=0);if(!Tb){Tb={};for(var d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),e=["+/=","+/","-_=","-_.","-_"],f=0;5>f;f++){var g=d.concat(e[f].split(""));Sb[f]=g;for(var h=0;h<g.length;h++){var k=g[h];void 0===Tb[k]&&(Tb[k]=h)}}}c=Sb[c];d=[];for(e=0;e<b.length;e+=3){var l=b[e],n=(f=e+1<b.length)?
...
return a.join("")}
;var Qg=z("ytLoggingTimeDocumentNonce_")||Pg();y("ytLoggingTimeDocumentNonce_",Qg,void 0);function Rg(a){this.f=a}
...
y("yt_logging_screen.getRootVeType",Wg,void 0);function Xg(){var a=Wg(0),b;a?b=new Rg({veType:a,youtubeData:void 0}):b=null;return b}
...
y("yt_logging_screen.setCurrentScreen",bh,void 0);function ch(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=P("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=P("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=J(K(3,window.location.href));g&&f.push(g);g=J(K(3,d));if(0<=La(f,g)||!g&&0==d.lastIndexOf("/",0))if(Q("autoescape_tempdata_url")&&(f=document.createElement("a"),Kb(f,d),d=f.href),d){g=d.match(kc);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||
...
eh.prototype.toString=function(){return this.topic};var fh=z("ytPubsub2Pubsub2Instance")||new N;N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.N;N.prototype.publish=N.prototype.M;N.prototype.clear=N.prototype.clear;y("ytPubsub2Pubsub2Instance",fh,void 0);var gh=z("ytPubsub2Pubsub2SubscribedKeys")||{};y("ytPubsub2Pubsub2SubscribedKeys",gh,void 0);var hh=z("ytPubsub2Pubsub2TopicToKeys")||{};y("ytPubsub2Pubsub2TopicToKeys",hh,void 0);var ih=z("ytPubsub2Pubsub2IsAsync")||{};y("ytPubsub2Pubsub2IsAsync",ih,void 0);
...
Ra(k.args))}catch(p){throw p.message="yt.pubsub2.Data.deserialize(): "+p.message,p;}}catch(p){throw p.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+p.message,p;}a.call(window,f)}catch(p){je(p)}},ih[b.toString()]?z("yt.scheduler.instance")?Bf(g):R(g,0):g())});
...
vh.prototype.clone=function(){var a=new vh,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==za(c)?a[b]=lb(c):a[b]=c}return a};function wh(){L.call(this);this.f=[]}
...
function Ih(a){var b=!0,c=Jh(a);c&&a.f&&(a=Kh(a),b=ef(c,"version")===a);return b&&!!z("yt.player.Application.create")}
function Fh(a){if(!a.g&&!a.K){var b=Ih(a);if(b&&"html5"==(Jh(a)?"html5":null))a.R="html5",a.w||Lh(a);else if(Mh(a),a.R="html5",b&&a.l)a.X.appendChild(a.l),Lh(a);else{a.f&&(a.f.loaded=!0);var c=!1;a.A=function(){c=!0;if(a.i)var d=a.i.serializedExperimentFlags;else a.f&&a.f.args&&(d=a.f.args.fflags);d="true"==le(d||"").player_bootstrap_method?z("yt.player.Application.createAlternate")||z("yt.player.Application.create"):z("yt.player.Application.create");var e=a.f?a.f.clone():void 0;d(a.X,e,a.i);Lh(a)};
a.K=!0;b?a.A():(tf(Kh(a),a.A),yh(a.i?a.i.cssUrl:a.f.assets.css),Nh(a)&&!c&&y("yt.player.Application.create",null,void 0))}}}
...
function Qh(a,b){var c="ytPlayer"+b+a.U;a.j[b]=c;x[c]=function(d){var e=R(function(){if(!a.g){a.H.M(b,d);var f=a.S,g=String(e);g in f&&delete f[g]}},0);
jb(a.S,String(e))};
return c}
...
m.o=function(){Mh(this);if(this.l&&this.f&&this.l.destroy)try{this.l.destroy()}catch(b){je(b)}this.Y=null;for(var a in this.j)x[this.j[a]]=null;this.ba=this.f=this.api=null;delete this.X;delete this.m;L.prototype.o.call(this)};
...
function bi(a){var b;(b=z("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Ka("ytcsi."+(a||"")+"data_",b));return b}
...
;function ki(){var a=z("ytcsi.debug");a||(a=[],y("ytcsi.debug",a,void 0),y("ytcsi.reference",{},void 0));return a}
function li(a){a=a||"";var b=z("ytcsi.reference");b||(ki(),b=z("ytcsi.reference"));if(b[a])return b[a];var c=ki(),d={timerName:a,info:{},tick:{}};c.push(d);return b[a]=d}
;function mi(a,b,c){c=void 0===c?{}:c;var d=Ng;P("ytLoggingEventsDefaultDisabled",!1)&&Ng==Ng&&(d=null);Dg(a,b,d,c)}
;var ni=z("ytLoggingLatencyUsageStats_")||{};y("ytLoggingLatencyUsageStats_",ni,void 0);function oi(){this.f=0}
...
if(Q("overwrite_polyfill_on_logging_lib_loaded")){var zi=window;zi.ytcsi&&(zi.ytcsi.info=yi)};B(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||xa,X);function Ai(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
...
function Ci(a,b,c){if(Ca(a)){b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function Di(a,b,c,d){if(Ca(a)&&!Aa(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
;function Ei(a){a=void 0===a?!1:a;L.call(this);this.f=new N(a);Qc(this,Ja(Rc,this.f))}
...
this))}
r(Qi,Ni);m=Qi.prototype;m.ma=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Ai(a)){var d=b;if(Ca(d[0])&&!Aa(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Ci.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Bi.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Di.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);Ai(a)&&Pi(this,this.fa())}};
...
m.dispose=function(){Ni.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function Ri(a,b,c){L.call(this);this.f=a;this.i=c;this.j=V(window,"message",B(this.l,this));this.h=new Fi(this,a,b);Qc(this,Ja(Rc,this.h))}
...
Ri.prototype.o=function(){$f(this.j);this.f=null;L.prototype.o.call(this)};function Si(){var a=lb(Ti),b;return nd(new M(function(c,d){a.onSuccess=function(e){ye(e)?c(e):d(new Ui("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new Ui("Unknown request error","net.unknown",e))};
a.O=function(e){d(new Ui("Request timed out","net.timeout",e))};
b=Ie("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof od&&b.abort();
return ld(c)})}
...
Vi.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),Tc(a)?a:Wi(a)):2===this.g&&b?(a=b.call(c,this.f),Tc(a)?a:Xi(a)):this};
...
;function Yi(a){F.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Zi;this.isTimeout=a instanceof Ui&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof od}
r(Yi,F);Yi.prototype.name="BiscottiError";function Zi(){F.call(this,"Biscotti ID is missing from server")}
r(Zi,F);Zi.prototype.name="BiscottiMissingError";var Ti={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},$i=null;function ee(){if("1"===fb(ce(),"args","privembed"))return ld(Error("Biscotti ID is not available in private embed mode"));$i||($i=nd(Si().then(aj),function(a){return bj(2,a)}));
return $i}
...
function cj(a,b){R(function(){nd(Si().then(aj,function(c){return bj(b,c)}),xa)},a)}
function dj(){try{var a=z("yt.ads.biscotti.getId_");return a?a():ee()}catch(b){return ld(b)}}
;function ej(a){if("1"!==fb(ce(),"args","privembed")){a&&de();try{dj().then(function(){},function(){}),R(ej,18E5)}catch(b){je(b)}}}
;var Z=z("ytglobal.prefsUserPrefsPrefs_")||{};y("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function fj(){this.f=P("ALT_PREF_COOKIE_NAME","PREF");var a=Vb.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
...
ya(fj);var jj=null,kj=null,lj=null,mj={};function nj(a){var b=a.id;a=a.ve_type;var c=Tg++;a=new Rg({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});mj[b]=a;b=Zg();c=Xg();b&&c&&th(b,c,[a])}
...
var sj=ie(function(){var a=ai(void 0),b;(b=!Q("use_first_tick"))||(b=!("ol"in ai(void 0)));if(b&&(b="ol",X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b)),b=T(),a.ol=b,a=xi(void 0),a.gelTicks&&(a.gelTicks.tick_ol=!0),T(),wi(void 0)?(li("").tick.ol=T(),a=di(void 0),pi().tick("ol",a,void 0),ei(),a=!0):a=!1,!a)){if(!z("yt.timing.pingSent_")&&(b=P("TIMING_ACTION",void 0),a=ai(void 0),z("ytglobal.timingready_")&&b&&a._start&&$h())){ei();b=!0;var c=P("TIMING_WAIT",[]);if(c.length)for(var d=
0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}if(b&&!wi(void 0)){d=ai(void 0);c=ci(void 0);e=d._start;var f=P("CSI_SERVICE_NAME","youtube");b={v:2,s:f,action:P("TIMING_ACTION",void 0)};a=c.srt;void 0!==d.srt&&delete c.srt;if(c.h5jse){var g=window.location.protocol+z("ytplayer.config.assets.js");(g=X.getEntriesByName?X.getEntriesByName(g)[0]:null)?c.h5jse=Math.round(c.h5jse-g.responseEnd):delete c.h5jse}d.aft=$h();var h=ai(void 0);g=h.pbr;var k=h.vc;h=h.pbs;g&&k&&h&&g<k&&k<h&&ci(void 0).yt_pvis&&
"youtube"==f&&(yi("yt_lt","hot_bg",void 0),f=d.vc,g=d.pbs,delete d.aft,c.aft=Math.round(g-f));for(var l in c)"_"!=l.charAt(0)&&(b[l]=c[l]);d.ps=T();l={};f=[];for(var n in d)"_"!=n.charAt(0)&&(g=Math.round(d[n]-e),l[n]=g,f.push(n+"."+g));b.rt=f.join(",");(n=z("ytdebug.logTiming"))&&n(b,l);n=!!c.ap;Q("debug_csi_data")&&(c=z("yt.timing.csiData"),c||(c=[],Ka("yt.timing.csiData",c)),c.push({page:location.href,time:new Date,args:b}));c="";for(var p in b)b.hasOwnProperty(p)&&(c+="&"+p+"="+b[p]);p="/csi_204?"+
c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&n){var v=void 0===v?"":v;Te(p,v)||Qe(p,void 0,void 0,void 0,v)}else Qe(p);y("yt.timing.pingSent_",!0,void 0);jh(Yh,new Wh(l.aft+(a||0),void 0))}}li("").tick.ol=T()}v=fj.getInstance();n=!!((ij("f"+(Math.floor(119/31)+1))||0)&67108864);p=1<window.devicePixelRatio;document.body&&Fc(document.body,"exp-invert-logo")&&(p&&!Fc(document.body,"inverted-hdpi")?(l=document.body,l.classList?l.classList.add("inverted-hdpi"):Fc(l,"inverted-hdpi")||
(a=Cc(l),Dc(l,a+(0<a.length?" inverted-hdpi":"inverted-hdpi")))):!p&&Fc(document.body,"inverted-hdpi")&&Gc());n!=p&&(n="f"+(Math.floor(119/31)+1),l=ij(n)||0,l=p?l|67108864:l&-67108865,0==l?delete Z[n]:(p=l.toString(16),Z[n]=p.toString()),v.save())}),tj=ie(function(){var a=jj;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();P("PL_ATT")&&Lf.dispose();a=0;for(var b=Ef.length;a<b;a++){var c=Ef[a];if(!isNaN(c)){var d=z("yt.scheduler.instance.cancelJob");d?d(c):S(c)}}Ef.length=0;yf("//static.doubleclick.net/instream/ad_status.js");Ff=!1;O("DCLKSTAT",0);Sc(lj,kj);if(a=jj)a.removeEventListener("onScreenChanged",oj),a.removeEventListener("onLogClientVeCreated",nj),a.removeEventListener("onLogServerVeCreated",pj),a.removeEventListener("onLogVeClicked",qj),a.removeEventListener("onLogVesShown",
rj),a.destroy();mj={}});
window.addEventListener?(window.addEventListener("load",sj),window.addEventListener("unload",tj)):window.attachEvent&&(window.attachEvent("onload",sj),window.attachEvent("onunload",tj));Ka("yt.abuse.player.botguardInitialized",z("yt.abuse.player.botguardInitialized")||Rf);Ka("yt.abuse.player.invokeBotguard",z("yt.abuse.player.invokeBotguard")||Sf);Ka("yt.abuse.dclkstatus.checkDclkStatus",z("yt.abuse.dclkstatus.checkDclkStatus")||Hf);
Ka("yt.player.exports.navigate",z("yt.player.exports.navigate")||ch);Ka("yt.util.activity.init",z("yt.util.activity.init")||dg);Ka("yt.util.activity.getTimeSinceActive",z("yt.util.activity.getTimeSinceActive")||gg);Ka("yt.util.activity.setTimestamp",z("yt.util.activity.setTimestamp")||eg);}).call(this);
