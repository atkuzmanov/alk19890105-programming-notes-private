...
$.get("/content/userUploadedImage/", function(res){
			
  $("#imgList").html(res);
  $("#imageoverlay").show();
  initialOverlayLoad('imageoverlay'); 
...
var html = "<div><";
popup2.content = 'This DIV w<br><img  src="/images/session.png" height="32" width="32" onclick="showUserImage();" /><br><a href="javascript:return;" onclick="_close();">Close[X]</a><br><br><div id="htmldata"></div>';

//popup2.content = 'This DIV w<br><br><a href="#" onclick="'+popup2.ref+'.hide();return false;">Close[X]</a>';
popup2.width = 400;
popup2.height = 300;
popup2.style = {'border':'1px solid black','backgroundColor':'white'};
//popup2.showModal();
...
_15d.preview=$(_161).parent().find(".wmd-preview")[0];
//_15d.preview=_6.getElementsByClass("wmd-preview",null,"div")[count];	
...
_18d=_18d.replace(/</g,"&lt;");
//_18d =_18d.replace(/&#95;/g,"_");
//_169.output.innerHTML="<pre><code>"+_18d+"</code></pre>";
_169.output.innerHTML="<pre>"+_18d+"</pre>";
}
}
if(_169.preview){
