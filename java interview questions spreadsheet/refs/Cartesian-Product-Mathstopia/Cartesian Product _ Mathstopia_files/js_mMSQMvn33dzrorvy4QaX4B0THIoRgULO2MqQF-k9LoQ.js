...
jQuery( function($) {
	$(document).ready(function(){
		$(".menu-block-wrapper li ul.menu li.leaf").prepend("<div class='leaf-separator'>—&nbsp;&nbsp;</div>");
		$('.active-trail').addClass('expanded-menu');

		 $(".menu-block-wrapper ul.menu > li").click(function (e) {
            e.stopPropagation();
            $(this).children("ul.menu").slideToggle(100);
