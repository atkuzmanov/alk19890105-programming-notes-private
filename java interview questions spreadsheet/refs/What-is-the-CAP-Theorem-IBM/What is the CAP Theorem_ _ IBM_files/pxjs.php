(function jvxPixelWrapper() {
    ...
    var isDebug = false;
    var pixelParams = {"rev":"0","px":"55b62d30733860","type":"application/javascript","cOpt":"undefined|undefined"};
...
// refer to help link for more options
    ...
    function firePixel(pixelId, pixelValObj) {
        ...
        var uniqueId = Math.floor(Math.random() * (10000)),
            cPxlURL = "//pxl.jivox.com/tags/conv/pxre.php",
    ...
    if (Object.prototype.toString.call(cData) === '[object Object]') {
        firePixel("55b62d30733860", cData);
    }
