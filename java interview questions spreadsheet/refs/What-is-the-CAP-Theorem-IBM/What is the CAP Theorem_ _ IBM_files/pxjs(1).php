(function jvxPixelWrapper(){
    ...
    var existingData = [];
    var existingGroups = {};
    var pixelParams = {"px":"85b62d1f515b04","type":"application/javascript","cData":"Cloud-Gen-US"};
    var gdprParams = "";
 ...
 return   [pixelParams.cData];
    ...
    function firePixel(pixelId, pixelValArr) {
        var pixelURL = "//pxl.jivox.com/tags/re/pxrc.php?c=1&px=" + pixelId + "" + gdprParams + us_privacy_string; // basic URL
    ...
    function fireMultiPixel(pixelValObj) {
        ...
        if (pixelParams.pxType == null || pixelParams.pxType == "1") {
            ...
            jvxForm.method = "post";
            jvxForm.action = "//pxl.jivox.com/tags/re/pxrc.php?"+ gdprParams + us_privacy_string;
