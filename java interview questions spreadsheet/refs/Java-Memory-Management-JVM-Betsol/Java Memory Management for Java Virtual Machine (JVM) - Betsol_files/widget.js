...
var w7196_widget = {
	baseUrl: 'https://tools.prnewswire.com/en-us/live/7196/',
	...
	run_ajax: function(){
		...
		if ( navigator.appName == 'Microsoft Internet Explorer' ) {
			...
			ajax.onload=function(){
				document.getElementById('w7196_widget').innerHTML =  ajax.responseText;
				w7196_widget.format_dates();
	...
	format_dates: function(){
		...
		var dates = document.querySelectorAll('#w7196_widget .w7196_datetime.localized');
