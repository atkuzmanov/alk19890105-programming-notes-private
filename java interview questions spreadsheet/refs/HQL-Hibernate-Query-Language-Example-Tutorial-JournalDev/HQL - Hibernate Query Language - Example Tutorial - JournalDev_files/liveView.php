...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.sekindo.com/live/liveView.php?s=95577&cbuster=638407776&pubUrl=https://www.journaldev.com/2954/hibernate-query-language-hql-example-tutorial&x=630&y=430&vp_content=plembedd55vwhtgjprx&vp_template=3700&schain=1.0,1!newormedia.com,2273,1&cbuster=1581696825',
					origQString: 's=95577&cbuster=638407776&pubUrl=https://www.journaldev.com/2954/hibernate-query-language-hql-example-tutorial&x=630&y=430&vp_content=plembedd55vwhtgjprx&vp_template=3700&schain=1.0,1!newormedia.com,2273,1',
					x: 630,
					y: 430,
					isSlider: false,
					isOutstream: false,
